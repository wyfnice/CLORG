...
from CIFAR.utils import load_state_dict_from_url
...
class _DenseLayer(nn.Module): #denseblock里面有几个bottleneck
    #BN->RELU->CONV1×1->BN->RELU->CONV3×3
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, memory_efficient=False): #num_feature=growth_rate
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        #print(self.features) # denseblock之前的7×7conv和2×2maxpooling
