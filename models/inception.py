...
from NewCL.CIFAR._builder import build_model_with_cfg
from NewCL.CIFAR._manipulate import flatten_modules
from NewCL.CIFAR._registry import register_model, generate_default_cfgs, register_model_deprecations
...
class InceptionResnetV2(nn.Module):
    ...
    def forward(self, x):
        x , feat_list = self.forward_features(x)
...
default_cfgs = generate_default_cfgs({
    ...
    'inception_resnet_v2.tf_in1k': {
        'hf_hub_id': 'timm/',
        'num_classes': 4, 'input_size': (3, 299, 299), 'pool_size': (8, 8),
